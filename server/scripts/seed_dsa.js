...
const SEED_FILE = path.join(__dirname, '../data/dsa-questions-seed.json');
...
async function generateChallengeData(model, question) {
  const prompt = `You are an expert DSA instructor creating high-quality coding challenges for DevArena.
...
{
  "description": "Markdown string describing the problem clearly, including constraints and examples.",
  "starterCode": {
